...
export default function Sidebar({ isMobileOpen = false, onCloseMobile }: SidebarProps) {
  ...
  const menuItems = [
    ...
    { name: "Admin Delegation", href: "/admin-delegation", icon: ShieldCheck },
    { name: "Transactions", href: "/transactions", icon: ArrowUpDown },
    { name: "KYC Review", href: "/kyc", icon: FileCheck },
    { name: "Withdrawals", href: "/withdrawals", icon: Download },
    { name: "Crypto Transfers", href: "/crypto-transfers", icon: Send },
  ...
  return (
    <aside className={`sidebar ${collapsed ? "collapsed" : ""} ${isMobileOpen ? "mobile-open" : ""}`} style={{ width: collapsed ? "80px" : "260px" }}>
