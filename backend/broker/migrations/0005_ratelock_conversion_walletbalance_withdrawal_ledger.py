...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('broker', '0004_alter_transaction_asset'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_asset', models.ForeignKey(db_column='from_asset', on_delete=django.db.models.deletion.CASCADE, related_name='rate_locks_from', to='rates.asset', to_field='code')),
                ('to_asset', models.ForeignKey(db_column='to_asset', on_delete=django.db.models.deletion.CASCADE, related_name='rate_locks_to', to='rates.asset', to_field='code')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rate_locks', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_asset', models.ForeignKey(db_column='from_asset', on_delete=django.db.models.deletion.PROTECT, related_name='conversions_from', to='rates.asset', to_field='code')),
                ('to_asset', models.ForeignKey(db_column='to_asset', on_delete=django.db.models.deletion.PROTECT, related_name='conversions_to', to='rates.asset', to_field='code')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='conversions', to=settings.AUTH_USER_MODEL)),
                ('rate_lock', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='conversions', to='broker.ratelock')),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('asset', models.ForeignKey(db_column='asset', on_delete=django.db.models.deletion.CASCADE, related_name='wallet_balances', to='rates.asset', to_field='code')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='wallet_balances', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-updated_at'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset', models.ForeignKey(db_column='asset', on_delete=django.db.models.deletion.PROTECT, related_name='withdrawals', to='rates.asset', to_field='code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wallet_balance', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ledger_entries', to='broker.walletbalance')),
            ],
            options={
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['user', '-created_at'], name='broker_ledg_user_id_8274a3_idx'), models.Index(fields=['wallet_balance', '-created_at'], name='broker_ledg_wallet__569355_idx')],
            },
        ),
    ]
