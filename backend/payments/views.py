...
def submit_bank_transfer(request, transaction_id, payload):
    transaction = get_object_or_404(Transaction, id=transaction_id, payment_method=Transaction.BANK_TRANSFER)
    ...
    payment_record.save(update_fields=["status", "receipt_reference", "receipt_note", "user_confirmed_at"])
