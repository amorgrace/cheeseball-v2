    ...
    if asset.code != NGN_CODE:
        ...
        try:
            ...
            try:
                ...
                telegram_msg = (
                    f"⚠️ <b>CRYPTO WITHDRAWAL FAILED</b>\n"
                    f"━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
                    f"👤 User: {html.escape(user.email)}\n"
                    f"🪙 Asset: {html.escape(asset.code)}\n"
                    f"💰 Amount: {amount} {html.escape(asset.code)}\n"
        ...
        try:
            ...
            telegram_msg = (
                ...
                f"👤 User: {html.escape(user.email)}\n"
                f"💵 Amount: ₦{amount:,.2f}\n"
                f"🏦 Bank: {html.escape(bank_name)} — {html.escape(bank_account_number)}\n"
                f"👤 Account: {html.escape(bank_account_name)}\n"
